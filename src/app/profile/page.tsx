...
function ProfileContent() {
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      alert('Suscripción cancelada exitosamente. Mantendrás acceso hasta el final del período actual.');
  ...
  const getSubscriptionStatus = () => {
    if (!user?.isSubscribed) return { text: "Cancelada (activa hasta el final del período)", color: "text-orange-600" };
    return { text: "Activa", color: "text-green-600" };
  };

  const extra = user?.extra_tokens || 0;
  const monthly = user?.monthly_tokens || 0;
  const remainingTokens = extra + monthly;
        ...
        <div className="text-center">
          ...
          {user?.isSubscribed && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
              <div className="flex items-center justify-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-blue-800">Suscripción Premium</h2>
              </div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <p className="text-lg font-semibold">
                      {user?.subscriptionEndDate ? formatDate(user.subscriptionEndDate.toString()) : 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {remainingTokens && (
                <div className="text-center mb-4">
                  ...
                  <p className="text-2xl font-bold text-green-600">{remainingTokens}</p>
                </div>
              )}
                ...
                <div className="bg-orange-100 border border-orange-200 rounded-lg p-4">
                  <div className="flex items-center justify-center">
                    ...
                    <p className="text-sm text-orange-700">
                      ...
                      {user?.subscriptionEndDate ? formatDate(user.subscriptionEndDate.toString()) : 'final del período'}
                    </p>
                  </div>
                </div>
              )}
          ...
          {!user?.isSubscribed && (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
              <h2 className="text-xl font-semibold text-gray-700 mb-4">Cuenta Gratuita</h2>
              <p className="text-gray-600 mb-4">Actualiza a Premium para obtener más funciones</p>
              <Button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">¿Cancelar Suscripción?</h3>
              <p className="text-gray-600 mb-6">
                Tu suscripción se cancelará, pero mantendrás acceso a todas las funciones Premium 
                hasta el final de tu período actual de facturación.
              </p>
