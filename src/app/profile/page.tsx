...
function ProfileContent() {
  ...
  const getSubscriptionStatus = () => {
    if (!user?.isSubscribed) return { text: "Sin suscripción", color: "text-gray-600" };
    if (user?.subscriptionCanceled) return { text: "Cancelada (activa hasta el final del período)", color: "text-orange-600" };
          ...
          {user?.isSubscribed && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
              ...
              <div className="text-center mb-4">
                ...
                <p className="text-2xl font-bold text-green-600">{totalOfTokens}</p>
              </div>
